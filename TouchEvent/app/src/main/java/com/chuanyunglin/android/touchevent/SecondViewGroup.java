...
public class SecondViewGroup extends LinearLayout {
    private static final String TAG = SecondViewGroup.class.getSimpleName();
    ...
    public SecondViewGroup(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
